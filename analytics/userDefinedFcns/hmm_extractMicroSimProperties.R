### Extract Microsimulation Properties for Hidden Markov Model Script
...
# local functions
hmm_extractMicroSimProperties <- function(cleanData)
{
  microSimProperties <- list()
  # extract microSimProperties here
  return(microSimProperties)
}