...
analyzeSimonData_initialModels <- function(processedData)
{
  ...
  cat(seperator)
  print(summary(nyha.age_weight_height_sex)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.heartpar)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.steppar)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.meanDailyMaxSteps)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.meanDailyTotalSteps)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.hr1minDrop)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.weight)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.bothSteps_hr_w)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.maxSteps_hr1minDrop_weight)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.totalSteps_hr1minDrop)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.weight_meanDailyTotalSteps)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.weight_hr1minDrop_meanDailyTotalSteps)) # Show summary statistics
  ...
  cat(seperator)
  print(summary(nyha.meanDailyMaxSteps_hr1minDrop)) # Show summary statistics
  models[["nyha.meanDailyMaxSteps_hr1minDrop"]] <- nyha.meanDailyMaxSteps_hr1minDrop
  ...
  cat(seperator)
  print(summary(nyha.weight_meanDailyMaxSteps)) # Show summary statistics
